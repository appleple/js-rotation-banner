...
<<<<<<< HEAD
console.log("f7750557-844a-4fde-856c-f6edab889541");
class RotationBanner {
    ...
    DisplayBanner() {
        axios_1.default.get("https://mac.appleple.jp/blog/api/rotation-banner/", {
            headers: { 'X-API-KEY': "f7750557-844a-4fde-856c-f6edab889541" || 0 },
        }).then((response) => {
            ...
            jsRotationBannerElements.forEach((element) => {
                ...
                for (let i = 0; i < displayIsNumber; i++) {
                    //生成されたDOMを代入
                    const table = this.GeneratingIdealDomHierarchy(copyBannerInfoArrays);
...
window.onload = () => {
    ...
    axios_1.default.get("https://mac.appleple.jp/blog/api/rotation-banner/", {
        ...
        .catch((error) => { console.log(error); })
        .finally(() => { });
    // const url: string = 'https://mac.appleple.jp/blog/api/rotation-banner/'
